...
export const commonUiStrings = {
  ...
  seeImageLicenses: {
    ...
    ta: "See licenses for images used on this page"
  },
  usesCookies: {
    en: () =>
  ...
  license: {
    ...
    ta: `All content on this page has been adapted from <a href="https://en.wikipedia.org">Wikipedia</a> under the terms of the <a href="https://creativecommons.org/licenses/by-sa/3.0/legalcode">CC-BY-SA 3.0 license</a>.`
  }
};
...
export const homeUiStrings = {
  ...
  wrongAnswer: {
    en: option =>
      `Wrong answer! The correct answer is option ${option}. Learn more:`,
    hi: option => `गलत जवाब! विकल्प ${option} सही उत्तर है। अधिक जानें:`,
    ta: option =>
