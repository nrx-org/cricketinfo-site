...
//     विराट_कोहली: "/static/content/hi/virat_kohli.json"
//   },
//   en: {
...
//     Virat_Kohli: "/static/content/en/virat_kohli.json",
//     Sachin_Tendulkar: "/static/content/en/sachin_tendulkar.json"
//   },
//   ta: {
//     விராத்_கோலி: "/static/content/ta/virat_kohli.json"
//   }
// };
...
// const CONTENT_URLS = JSON.parse(fs.readFileSync("./bin/content_urls"));
...
export const getMainPageUrl = lang => `${getBaseUrl()}/wiki/${lang}`;

export const articleContentUrl = (articleId, lang) => {
  console.log(CONTENT_URLS);
  console.log("article ID is " + articleId + "lang is " + lang);
